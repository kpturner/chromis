 ...
 *
 * @description 
 * This is a modified version of {@link https://github.com/balderdashy/sails-hook-email}
 * created by Kevin Turner to be used while waiting for a suitable fix to cater for 
 * {@link https://github.com/balderdashy/sails-hook-email/issues/24}
 *  
...
module.exports = function chremail(sails) {
  ...
  return {
    ...
    /**
     * @name    hook.chremail.send
     * @method
     * @description Send an email.
     * @param  {String}    template (a named template to render)
     * @param  {Object}   data (data to pass into the template)
     * @param  {Object}   options (email options including to, from, etc {@link https://github.com/nodemailer/nodemailer/blob/v1.3.4/README.md#e-mail-message-fields})
     * @param  {Function} cb
     */
    ...
    /**
     * @name    hook.chremail.transporter
     * @method
     * @return {Object}
     */
